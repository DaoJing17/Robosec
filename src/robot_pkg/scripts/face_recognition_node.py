...
known_face_encodings = [daojing_face_encoding, jielun_face_encoding, jinseng_face_encoding, xuyang_face_encoding, uwais_face_encoding, yuxuan_face_encoding]
known_face_names = ["daojing", "jielun", "jinseng", "uwais","xuyang", "yuxuan"]
